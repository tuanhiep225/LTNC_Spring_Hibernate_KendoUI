$(document).ready(function () {
    var dataSource = new kendo.data.DataSource({
        transport: {
            ...
            create: {
                url: "/LTNC/api/product-color/create",
                type: "post",
                dataType: 'json',
                contentType: "application/json"
            },
            update: {
                url: "/LTNC/api/product-color/update",
                type: 'post',
                dataType: 'json',
                contentType: "application/json"
            },
            destroy: {
                url: "/LTNC/api/product-color/delete",
                type: 'post',
                dataType: "json",
                contentType: "application/json"
            },
            parameterMap: function (data, type) {
                if (type !== "read") {
                    if (type === "create") {
                    	var arr={
                    			productColorName:data.models[0].productColorName,
                    			isActive:true
                    	}
    ...
    var grid = $("#grid-color").kendoGrid({
        ...
        columns: [
                {
                    field: "productColorName", title: "Tên Màu", width: 400,
                },
